...
export const metadata: Metadata = {
  title: "Jagjit Bhosale | Computer Science Student & Developer",
  description:
    "Passionate Computer Science student specializing in AI/ML and full-stack development. Winner of 3+ hackathons with innovative tech solutions.",
  generator: "v0.app",
}
